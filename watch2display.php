...
$rowSQL = mysql_query( "SELECT MAX(amount) AS max FROM watch1;" );
$row = mysql_fetch_array( $rowSQL );
$largestNumber = $row['max'];
$rowuser=mysql_query( "SELECT username AS user FROM watch1 where amount=($largestNumber);" );

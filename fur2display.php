...
<table class="right" style="background-color:#ddd;"> 
    ...
    <th><img src="furniture2.png" alt="Classic Watch" width="228" height="228"></th>
    <th><a href="furniture2.php">INTERIOR </a></th>
     <th>
        <p>Interiors
Including Noble & Private Collections
London
...
$rowSQL = mysql_query( "SELECT MAX(amount) AS max FROM furniture2;" );
$row = mysql_fetch_array( $rowSQL );
$largestNumber = $row['max'];
$rowuser=mysql_query( "SELECT username AS user FROM furniture2 where amount=($largestNumber);" );

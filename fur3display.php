...
<table class="right" style="background-color:#ddd;"> 
  ...
  <tr>
    <th><img src="furniture3.png" alt="Classic Watch" width="228" height="228"></th>
    <th><a href="furniture3.php">Rug</a></th>
    <th>
        <p>Rugs and Carpets
...
$rowSQL = mysql_query( "SELECT MAX(amount) AS max FROM furniture3;" );
$row = mysql_fetch_array( $rowSQL );
$largestNumber = $row['max'];
$rowuser=mysql_query( "SELECT username AS user FROM furniture3 where amount=($largestNumber);" );

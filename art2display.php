...
<table class="right" style="background-color:#ddd;"> 
   <tr>
    ...
    <th><a href="antique2.php">THE INTERIOR OF A GOTHIC CATHEDRAL)</a></th>
     <th>
        <p>Frans Francken II
...
$rowSQL = mysql_query( "SELECT MAX(amount) AS max FROM art2;" );
$row = mysql_fetch_array( $rowSQL );
$largestNumber = $row['max'];
$rowuser=mysql_query( "SELECT username AS user FROM art2 where amount=($largestNumber);" );

...
<table class="right" style="background-color:#ddd;"> 
  <tr>
    ...
    <th><a href="">CELLINI MOONPHASE</a></th>
    <th><p>EVEROSE </p></br>
...
$rowSQL = mysql_query( "SELECT MAX(amount) AS max FROM watch2;" );
$row = mysql_fetch_array( $rowSQL );
$largestNumber = $row['max'];
$rowuser=mysql_query( "SELECT username AS user FROM watch2 where amount=($largestNumber);" );

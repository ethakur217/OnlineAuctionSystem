...
<table class="right" style="background-color:#ddd;"> 
 ...
 <tr class="one">
    <th><img src="house1.png" alt="Classic Watch" width="228" height="228"></th>
    <th><a href="house1.php">OLIVE GREEN VELVET MODERNIST LOVE SEAT</th>
      <th>
        <p>Olive Green Velvet Modernist Love Seat. Low profile sloped arms. Tapered square wood legs.
-- Dimensions: H: 30 inches: W: 49 inches: D: 32 inches.
...
$rowSQL = mysql_query( "SELECT MAX(amount) AS max FROM house1;" );
$row = mysql_fetch_array( $rowSQL );
$largestNumber = $row['max'];
$rowuser=mysql_query( "SELECT username AS user FROM house1 where amount=($largestNumber);" );
